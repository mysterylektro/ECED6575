...
def problem_1(spectrum16: Spectrum,
    ...
    timeseries_analyzer = TimeseriesPlotter(timeseries)
...
def assign1b():
    ...
    timeseries = random_phase_spectrum65536.to_timeseries()
    timeseries.set_sample_rate(44100)
    recorded_timeseries = play_and_record_timeseries(timeseries)
    plotter = TimeseriesPlotter(recorded_timeseries)
    ...
    recorded_timeseries = play_and_record_timeseries(timeseries)
    plotter.set_timeseries(recorded_timeseries)
